...
<div class="w3-card">
	...
	<div class="w3-row padding-top-bottom-8">
		<div class="w3-col s12 m12 l6">
			<form name="add" method="post" action="{{route('my.bauk.holiday.add')}}">
				@csrf
				<input name="start" type="hidden" value="{{old('start')}}" />
				<input name="end" type="hidden" vale="{{old('end')}}" />
				@include('my.bauk.holiday.add_form')			
			</form>
		</div>
