<div id="attendanceProgress-month-modal" class="w3-modal w3-display-container w3-hide-large" onclick="$(this).hide()">
	<div class="w3-modal-content w3-animate-top w3-card-4">
		...
		<div id="attendanceProgress-month-modal-container" class="datepicker-inline-container">
