@extends('layouts.dashboard.dashboard', ['sidebar'=>'dashboard', 'title'=>trans('my/dashboard/hints.page.division')])
		...
		<div class="input-group padding-none-small">
			...
			<?php 
				$dropdown = [
					...
					'dropdown'	=> ['my.dashboard.division.landing_division_select', []],
					'modalTitle'=> trans('my/dashboard/hints.modal.division')
				];
			?>
...
<div class="w3-row">
	<div class="w3-col s12 m5 l5 w3-light-grey padding-left-none-small 
